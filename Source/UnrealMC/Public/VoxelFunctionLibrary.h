 ...
 */
UCLASS()
class UNREALMC_API UVoxelFunctionLibrary : public UBlueprintFunctionLibrary
{
	GENERATED_BODY()
	...
	UFUNCTION(BlueprintPure, Category = "Math")
		static FVector FloorVector(const FVector& Vector);

	UFUNCTION(BlueprintPure, Category = "Math")
		static FVector CeilVector(const FVector& Vector);
};
